...
int Parabola::intersectionPointsNum(const Point2D &f1, const Point2D &f2, double directrix) {
...
std::vector<Point2D> Parabola::findIntersectionPoints(const Point2D &f1, const Point2D &f2, double d) {
